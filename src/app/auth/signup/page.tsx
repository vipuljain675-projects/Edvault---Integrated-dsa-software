...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signInRes?.ok) {
        toast.success("Welcome to EduVault! 🚀");
    ...
    <div className="dashboard-light" style={{
      ...
      <div style={{ width: "100%", maxWidth: "440px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <h2 style={{ marginBottom: "0.4rem", fontSize: "1.6rem", fontWeight: 800, color: "var(--text-primary)" }}>Create your account</h2>
          <p style={{ color: "var(--text-muted)", fontSize: "0.9rem" }}>Join 12,400+ students learning smarter</p>
        </div>
        ...
        <div className="card" style={{ borderRadius: "16px", padding: "2rem", background: "var(--bg-surface)", border: "1px solid var(--border-default)", boxShadow: "var(--shadow-lg)" }}>
          ...
          <button
            ...
            style={{ width: "100%", marginBottom: "1.5rem", background: "var(--bg-elevated)", border: "1px solid var(--border-default)", color: "var(--text-primary)" }}
          >
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <User size={16} style={{ position: "absolute", left: "0.9rem", top: "50%", transform: "translateY(-50%)", color: "var(--text-disabled)" }} />
                <input
                  type="text"
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <Mail size={16} style={{ position: "absolute", left: "0.9rem", top: "50%", transform: "translateY(-50%)", color: "var(--text-disabled)" }} />
                <input
                  type="email"
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <Lock size={16} style={{ position: "absolute", left: "0.9rem", top: "50%", transform: "translateY(-50%)", color: "var(--text-disabled)" }} />
                <input
                ...
                <button
                  ...
                  style={{ position: "absolute", right: "0.9rem", top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: "var(--text-disabled)" }}
                >
                  ...
                  {passwordChecks.map(({ label, test }) => {
                    ...
                    return (
                      <div key={label} style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>
                        <CheckCircle2 size={13} color={passed ? "#10B981" : "var(--text-disabled)"} />
                        <span style={{ fontSize: "0.75rem", color: passed ? "#34D399" : "var(--text-disabled)" }}>
                          {label}
                        </span>
                      </div>
                    );
        ...
        <p style={{ textAlign: "center", marginTop: "1.5rem", fontSize: "0.875rem", color: "var(--text-muted)" }}>
          ...
          <Link href="/auth/login" style={{ color: "#6366F1", fontWeight: 700, textDecoration: "none" }}>
            Sign in
          </Link>
        </p>
      </div>
